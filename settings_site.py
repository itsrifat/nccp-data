...
NODE_IDENTIFIER = 'urn:node:mnTestNRDC'

# The human readable name of this node.
# E.g.: 'My Member Node'
NODE_NAME = 'NRDC Test Member Node'
...
NODE_DESCRIPTION = 'NRDC Test Member Node'
...
NODE_BASEURL = 'https://sensor.nevada.edu/DataONETest/mn'
...
NODE_SUBJECT = 'CN=urn:node:mnTestNRDC,DC=dataone,DC=org'
...
NODE_CONTACT_SUBJECT = 'CN=Md Moinul Hossain B26037,O=Google,C=US,DC=cilogon,DC=org'
...
SECRET_KEY = 'd53acf0e72362f8635e4d1d8585ccc32ed3edf9a8cc734c60a36b114a2891e1d'
